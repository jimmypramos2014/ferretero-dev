...
class Transferencia
{
    ...
    private $estado;
     ...
     /**
     * @ORM\OneToMany(targetEntity="TransferenciaXProducto", mappedBy="transferencia" , cascade={"remove"})
     */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="FacturaVenta", inversedBy="transferencia", cascade={"persist","remove"})
