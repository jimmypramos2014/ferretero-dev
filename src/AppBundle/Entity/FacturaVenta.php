...
class FacturaVenta
{
     ...
     * @var boolean
     *
     * @ORM\Column(name="detraccion", type="boolean", options={"default":0, "comment":"Indica si la Factura viene con detraccion"})
     */
    private $detraccion;
     ...
     * @var boolean
     *
     * @ORM\Column(name="enviado_sunat", type="boolean", nullable=true)
     */
     ...
     * @var boolean
     *
     * @ORM\Column(name="validar_nubefact", type="boolean", nullable=true, options={"default":0, "comment":"Fue validado con nubefact, sin errores"})
     */
    private $validarNubefact;
    ...
    {
        return $this->getTicket() ? $this->getTicket() : '' ;
    }
     ...
     * Set validarNubefact
     *
     * @param boolean $validarNubefact
     *
     * @return FacturaVenta
     */
    public function setValidarNubefact($validarNubefact)
    {
        $this->validarNubefact = $validarNubefact;
     ...
     * @return boolean
     */
    public function getValidarNubefact()
    {
        return $this->validarNubefact;
    }
