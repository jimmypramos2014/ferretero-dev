...
class Empresa
{
     ...
     * @var bool
     *
     * @ORM\Column(name="estado_pago", type="boolean", nullable=true, options={"default":1, "comment":"Estado de pago del cliente"})
     */
    private $estadoPago;
     ...
     * @var string
     *
     * @ORM\Column(name="mensaje_pago", type="string", length=1000, nullable=true)
     */
    private $mensajePago;
     ...
     * @var int
     *
     * @ORM\Column(name="paginado", type="integer", nullable=true)
     */
    private $paginado;
